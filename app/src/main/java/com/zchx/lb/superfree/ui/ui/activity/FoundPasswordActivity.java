...
//找回密码的界面
public class FoundPasswordActivity extends AppCompatActivity implements RegisterOkView {
    ...
    public void confirmVerifySuccess(String confirmVerifySuccessMsg) {
        if (confirmVerifySuccessMsg != null) {
            startActivity(new Intent(FoundPasswordActivity.this, ForgetPasswordActivity.class));
        }
        }
