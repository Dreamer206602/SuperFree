...
public final class EncryptUtil {
    ...
    public static String getPublicKey(KeyPair keyPair) {
        ...
        ret = EncodingUtils.Base64Encode(publicKey);
        return ret;
    }
    ...
    public static String getPrivateKey(KeyPair keyPair) {
        ...
        ret = EncodingUtils.Base64Encode(privateKey);
        return ret;
    }
    ...
    public static String rsaEncrptWithBase64(byte[] data, String key, Integer keyMode) {
        ...
        if (data != null && data.length > 0 && key != null && key.length() > 0) {
            byte[] keyData = EncodingUtils.Base64Decode(key);//获取key对象的字节数组
            ...
            //将加密后的数据编码
            ret = EncodingUtils.Base64Encode(encryptBytes);
        }
        return ret;
    }
